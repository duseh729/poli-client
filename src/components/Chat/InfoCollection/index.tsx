          ...
          <S.FormWrapper formHeight={formHeight}>
            <S.Form>
              ...
              <S.FormGroupWrapper>
                <S.FormGroup>
                  <S.Label>
                    <S.Highlight>피해 장소 |</S.Highlight> <S.ResponsiveBr />
                ...
                <S.FormGroup style={{ marginTop: 34 }}>
                  <S.Label>
                    <S.Highlight>피해 일시 |</S.Highlight> <S.ResponsiveBr />
                    언제 피해를 겪으셨나요? 날짜와 시간을 선택해 주세요.
                  </S.Label>
                  <S.InputRow>
                    <DatePicker
                      value={selectedDate}
                ...
                <S.FormGroup style={{ marginTop: 34 }}>
                  <S.Label>
                    <S.Highlight>피해 상세 상황 |</S.Highlight>{" "}
                    <S.ResponsiveBr />
                    어떤 상황이고 어떤 부분이 고민되는지 설명해 주세요.
                  </S.Label>
                  <S.ExampleText>
